...
제네릭 타입 T는 프로그래밍에서 다양한 데이터 타입에 대해 코드를 재사용할 수 있게 하는 타입 매개변수이다.  
이를 통해 코드를 더 일반적이고 유연하게 작성할 수 있으며, Dart의 `List<T>`나 Flutter의  
`ChangeNotifierProvider<T>` 같은 경우에 타입 안전성을 보장하며 특정 타입의 데이터에 접근할 수 있다.  
제네릭의 사용은 타입 안전성을 확보하고 코드 재사용성을 높이며 개발자의 의도를 명확하게 전달하는 데 도움을 준다.
```
...
<img src="/assets/img/Flutter/provider/provider_ex2.png" alt="" width="300" height="143">
<img src="/assets/img/Flutter/provider/provider_ex4.png" alt="" width="300" height="140">
<img src="/assets/img/Flutter/provider/provider_ex3.png" alt="" width="300" height="145">
